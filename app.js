...
var startDateTime = new Date(2021,05,22,23,59,59,0);
...
function updateClock() {
    ...
    document.getElementById("time-elapsed").innerHTML = "we are together for " + "1 Month "  + d+" day(s), "+h+" hour(s), "+m+" minute(s), "+s+" second(s) ";
}
